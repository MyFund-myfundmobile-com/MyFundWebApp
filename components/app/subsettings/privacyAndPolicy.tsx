...
const PrivacyAndPolicy: React.FC = () => {
  return (
    ...
    >
      <div className="flex justify-between items-center">
        <div>
          ...
          <Subtitle style={{ marginTop: -5 }}>
            Read about our privacy policies.
          </Subtitle>
        </div>
      ...
      <div
        className="rounded-lg p-4 mt-4 sm:p-6"
        style={{
      ...
      >
        <p>
          <span className="font-bold text-purple1">Privacy Policy:</span> Lorem
          ipsum dolor sit amet, consectetur adipiscing elit. Donec vel neque non
