...
const QuickInvestModal: React.FC<QuickInvestModalProps> = ({ isOpen, onClose, initialAmount }) => {
    ...
    <>
      <Modal
        ...
        body={
          <div>
            <p>
              Manually move funds from your local bank account into your <span style={{ color: '#4C28BC' }}>INVESTMENT</span> account with a few clicks.
            </p>
            <div className="mt-4">
              <TextField
                fullWidth
        ...
        buttonText={
          isSending ? (
            ...
            <>
              ...
              {selectedOption === 'Bank Transfer' ? "I've Sent The Payment" : 'QuickInvest Now!'}
            </>
          )
        }
