...
const Testimonials: React.FC = () => {
  const testimonials = useMemo(
    () => [
      {
        message:
          "MyFund is doing way better than all other savings app and here's why: None of them gives the returns MyFund does. The best of them gives 15% ROI max.",
        name: "Emmanuel Abolo",
      ...
      {
        message:
          "It's been very transforming being a part of MyFund. The things I've learnt from the Wealth Leadership Academy about finance, I couldn't have learnt anywhere else.",
        name: "David Olusegun",
      ...
      {
        message:
          "Ever since I've started this savings, it has really helped me pay more attention to my financial development. Thank you all for all you do.",
      ...
      {
        message:
          "I'm happy I've been able to save my first million using MyFund. Even though most people save for particular targets, I just do it for the rainy days.",
        name: "Bukola Johnson",
      ...
      {
        message:
          "MyFund helped me to be able to save enough to buy and own shares of the company. I wouldn't have been able to do it otherwise.",
        name: "Patrick Mundi",
  ...
  return (
    <div className="max-w-lg mx-auto py-12">
      <div className="relative rounded-full overflow-hidden w-32 h-32 mx-auto mb-6">
        <Img
          src={currentTestimonial.image || `/images/Profile1.png`}
      ...
      <div className="text-center">
        <div className="flex items-center mb-2">
          ...
          <p className="text-lg text-gray-400 ml-2 transition-opacity duration-1000 ease-in-out">
