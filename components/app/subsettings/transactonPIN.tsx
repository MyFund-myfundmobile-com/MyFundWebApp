...
const TransactionPIN: React.FC = () => {
  ...
  return (
    <Box
      className="px-6 animate-floatIn max-w-full"
      style={{ padding: "36px", borderRadius: "8px", backgroundColor: "#fff" }}
    >
      <div className="flex justify-between items-center">
        <div>
          <Title style={{ marginTop: -15 }}>My PIN</Title>
          <Subtitle style={{ marginTop: -5 }}>
            Create your PIN to perform faster and secure transactions on MyFund
          </Subtitle>
        </div>
      ...
      >
        ...
        >
          <IconButton
            onClick={() => handleBackspace(pin.findIndex((d) => d !== "") - 1)}
            style={{ fontSize: "34px", marginLeft: "10px" }}
          >
            <IonIcon
